...
import CookController from "./drinkCookController";
import { View, Text } from "react-native";
import styles from "./drinkCookStyles";
...
export default function DrinkCook({ navigation, route }: DrinkCookProps) {
    ...
    const ytUrl = controller.handleYtUrl(recipe.strVideo ?? "");

    return (
        <View style={styles.cookContainer}>
            <View style={styles.titleWrapper}>
                <Header goBack={() => navigation.goBack()} title={recipe.strDrink} />
            </View>
